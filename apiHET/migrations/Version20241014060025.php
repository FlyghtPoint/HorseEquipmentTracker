 ...
 */
final class Version20241014060025 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE movement (id INT AUTO_INCREMENT NOT NULL, reservation_id INT NOT NULL, movement_type LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', date DATETIME NOT NULL, INDEX IDX_F4DD95F7B83297E7 (reservation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, equipment_id INT NOT NULL, start_date DATETIME DEFAULT NULL, end_date DATETIME NOT NULL, status LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', type LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', INDEX IDX_42C84955A76ED395 (user_id), INDEX IDX_42C84955517FE9FE (equipment_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
